...
The simplest way is to download the latest release (for OSX and Linux) from https://github.com/scopej/klar/releases/ and put the binary in a folder in your `PATH` (make sure it has execute permission).
...
Klar can be dockerized. Go to `$GOPATH/src/github.com/scopej/klar` and build Klar in project root. If you are on Linux:
